...
label start:
    ...
    dasuk "흠.. 쟤는 오늘도 같은 길로 가나?"
    "들리지 않게 혼잣말로 중얼거린다."
    "하교 때 마다 항상 나와 같은 길을 가는 여자애가 있다."
    show daye default
    "저 흑발에 긴 머리."
    "어떤 날은 내가 앞서가고, 어떤 날은 그녀가 앞서 간다."
    "오늘은 그녀가 앞서가고 있다. 내가 좀 늦게 나온 탓이다."
    hide daye
    "..."
    "..."
    ...
    "???" "아얏!"
    show daye default
    "내가 정신이 팔려있던 사이, 어느새 그녀와의 거리가 0이 되었다."
    "별로 세게 부딫히진 않았지만 등 뒤에서 누군가가 툭 하고 닿으니 분명 놀랐을 것이다."
    dasuk "아, 미안!"
    "재빨리 사과한다. 괜스레 미안해진다."
    show daye default
    "???" "민다석."
